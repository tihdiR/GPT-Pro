      ...
      <section className='chatbox'>
        <ul className='chat_log'>
          {currentChat?.map((chatMessage, index) => <li key = {index}> 
            {/* <p className='profile'>{chatMessage.role}</p> */}
            ...
            {/* {chatMessage.role!=='user' && <div className='message_gpt'>{chatMessage.content}</div>} */}
            {/* {chatMessage.role==='user' && <div className='message'>{chatMessage.content}</div>} */}
            <div className='message'>{chatMessage.content}</div>
        ...
        {/* <div className='chat_log'>
          ...
          <div className='chat_message gpt'>
            <div className='chat_message_center'>
              <div className='profile gpt'>
              <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={41}
                    height={41}
